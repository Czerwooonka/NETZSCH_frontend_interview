...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_fromCelsiusToFahrenheit')) {
        Object.defineProperty(Module['ready'], '_fromCelsiusToFahrenheit', { configurable: true, get: function() { abort('You are getting _fromCelsiusToFahrenheit on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_fromCelsiusToFahrenheit', { configurable: true, set: function() { abort('You are setting _fromCelsiusToFahrenheit on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_fromFahrenheitToCelsius')) {
        Object.defineProperty(Module['ready'], '_fromFahrenheitToCelsius', { configurable: true, get: function() { abort('You are getting _fromFahrenheitToCelsius on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_fromFahrenheitToCelsius', { configurable: true, set: function() { abort('You are setting _fromFahrenheitToCelsius on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
  wasmBinaryFile = 'data:application/octet-stream;base64,';
...
/** @type {function(...*):?} */
var _fromCelsiusToFahrenheit = Module["_fromCelsiusToFahrenheit"] = createExportWrapper("fromCelsiusToFahrenheit");

/** @type {function(...*):?} */
var _fromFahrenheitToCelsius = Module["_fromFahrenheitToCelsius"] = createExportWrapper("fromFahrenheitToCelsius");
